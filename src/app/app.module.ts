...
@NgModule({
  declarations: [
    ...
    Min2Component, 
    Min3Component, 
    Min4Component, ViewContactsComponent, MinitryComponent, CreateMinComponent, EventComponent, CreateEventComponent, AdvertsComponent, SpeakersComponent, MinDetailsComponent, GiveComponent
  ],
  imports: [
    BrowserModule,
    FormsModule,
